...
**Researcher Development Operating System** — 초보 연구자를 *Research-Ready Scholar(연구 준비자, L5)* 로 성장시키는 운영체제형 학습 플랫폼.
...
| **L5** | Service / 성장모델 | `src/growth/levels.ts` | L1~L5 레벨 + XP 매핑 |
