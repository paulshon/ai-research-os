  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-[#0d0f14] text-[#e8eaf0] flex">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div
          className="md:hidden flex items-center justify-center gap-2.5 bg-[#13161e] border-b border-white/[0.06] flex-shrink-0"
        ...
        >
          <Link href="/dashboard" className="flex items-center gap-2.5">
            ...
            <span className="font-nanum-myeongjo text-[17px] font-semibold text-[#e8eaf0]">
