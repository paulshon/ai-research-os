...
import { RESEARCH_FLOW_ITEMS } from "@/components/dashboard/sidebar";
...
export default function TabletRail() {
  ...
  return (
    <aside className="hidden md:flex lg:hidden flex-col w-[204px] flex-shrink-0 imm-glass-strong border-r border-white/[0.06] h-screen py-3 px-2 gap-0.5 overflow-y-auto scrollbar-none relative z-[2]">
      {/* 로고 */}
      <Link
        href="/dashboard"
      ...
      >
        ...
        <BrandWordmark size={16} className="truncate" />
      </Link>
      ...
      {/* Research Flow */}
      <SectionLabel>{t("sidebar.sectionFlow")}</SectionLabel>
