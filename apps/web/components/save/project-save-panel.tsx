        ...
        <div className="rounded-[14px] border border-white/[0.06] bg-[#0f131b] p-2.5">
          <div className="flex items-center justify-between mb-2 px-0.5">
            ...
            {linkedFileLabel ? (
              ...
              <span className="text-[10px] text-white/30 flex items-center gap-1 min-w-0" title="자동 저장됨">
                <span className="w-1.5 h-1.5 rounded-full bg-[#6c8cff] flex-shrink-0 animate-pulse" />
                <span className="truncate">자동저장 {new Date(autoSavedAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}</span>
              </span>
            ) : null}
          </div>
