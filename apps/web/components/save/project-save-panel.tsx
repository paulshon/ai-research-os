    ...
    <>
      <div className="px-3 py-3 border-t border-white/[0.05] bg-[#13161e]">
        <div className="rounded-[14px] border border-white/[0.06] bg-[#0f131b] p-2.5">
          ...
          {/* 주 동작: 저장(파란) + 불러오기(흰 외곽) — 첨부 3번 그림 */}
          <div className="flex gap-1.5 mb-1.5">
            <button
              type="button"
              onClick={openSaveDialog}
              disabled={saving}
              className="flex-[1.35] flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-[10px] text-[13px] font-semibold bg-[#4a6cf7] text-white hover:bg-[#5a78ff] shadow-[0_4px_14px_rgba(74,108,247,.35)] transition-all disabled:opacity-50"
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-[10px] text-[13px] font-medium border border-white/45 text-white/90 bg-transparent hover:bg-white/[0.06] hover:border-white/70 transition-all disabled:opacity-50"
