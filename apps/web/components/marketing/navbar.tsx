...
export default function MarketingNavbar() {
  ...
  const NAV_LINKS = [
    { href: "/rdos-signup", label: "연구준비자 플랜" },
    { href: "/researcher-signup", label: "연구자 플랜" },
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <button
          ...
          className="lg:hidden text-white/50 hover:text-white p-2 text-xl"
        >
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-[#13161e]/98 backdrop-blur-xl border-t border-white/[0.04] px-6 py-5 space-y-1">
          {NAV_LINKS.map((l) => (
            <Link
              key={l.href}
              href={l.href}
