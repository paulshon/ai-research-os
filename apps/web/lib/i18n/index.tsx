...
import { koHero } from "./locales/ko-hero";
import { koOve } from "./locales/ko-ove";
import { enHero } from "./locales/en-hero";
import { enOve } from "./locales/en-ove";
import { zhHero } from "./locales/zh-hero";
import { zhOve } from "./locales/zh-ove";
...
const LOCALES: Record<Locale, TranslationDict> = {
  ko: mergeAll(ko, koPages, koRdos, koDash2, koAuth, koDash3, koMarketing2, koHero, koOve) as TranslationDict,
  en: mergeAll(en, enPages, enRdos, enDash2, enAuth, enDash3, enMarketing2, enHero, enOve) as TranslationDict,
  zh: mergeAll(zh, zhPages, zhRdos, zhDash2, zhAuth, zhDash3, zhMarketing2, zhHero, zhOve) as TranslationDict,
};
