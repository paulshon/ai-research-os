...
export default function StructurePage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row font-nanum-gothic">
      <PageSaveRegistration pageId="structure" getData={getData} />

      {/* v21: 모바일 AI 패널 토글 버튼 */}
      <div className="lg:hidden flex items-center justify-end px-3 py-1.5 border-b border-white/[0.04]">
        <button
      ...
      <div className="flex-1 min-w-0 overflow-y-auto p-4 md:p-6">
        ...
        <div className="mb-5">
          ...
          <p className="text-[14px] text-white/30">{t("pages.structure.desc")}</p>
        </div>
      ...
      <ResizableRightPanel storageKey="structure" className={`border-l border-white/[0.04] flex-col bg-[#0d0f14] overflow-y-auto ${showMobileAI ? "flex absolute inset-0 z-20 lg:relative" : "hidden lg:flex"}`}>

        {/* v21: 모바일 닫기 버튼 */}
        <div className="lg:hidden flex justify-end px-3 pt-2">
