    ...
    <div className="p-4 md:p-5 lg:px-6 lg:py-6 font-nanum-gothic">
      ...
      <div className="max-w-[1680px] mx-auto flex flex-col xl:flex-row gap-6 items-start">
        ...
        <div className="flex items-center justify-between mb-1">
          <h1 className="text-[23px] font-bold font-nanum-myeongjo"><Icon name="calendar" className="inline-flex align-[-0.125em] mr-1" size={18} /> {t("schedulePage.paperSchedule")}</h1>
