      ...
      <div className="max-w-[1680px] mx-auto">
        ...
        <div className="p-5 rounded-[16px] bg-[#13161e] border border-white/[0.04] mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-[13px] text-white/25">전체 진행률</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-5 mb-6">
          ...
          <div className="p-5 rounded-[16px] bg-[#13161e] border border-white/[0.04]">
            <p className="text-[16px] font-semibold text-[#e8eaf0] mb-4">빠른 시작</p>
        ...
        {/* 연구 흐름 내비게이션 */}
        <div className="p-5 rounded-[16px] bg-[#13161e] border border-white/[0.04]">
          <p className="text-[16px] font-semibold text-[#e8eaf0] mb-4">연구 흐름</p>
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { href: "/validation", icon: "🛡", label: "검토·검증", color: "#ff7066" },
              { href: "/schedule", icon: "🗓", label: "논문일정", color: "#e8b84b" },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
