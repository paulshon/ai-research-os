      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <section className="p-6 rounded-[18px] bg-[#13161e] border border-white/[0.04]">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-[15px] text-white/30 mb-3">{t("settingsPage.providerApiKeyLabel")}</label>
              ...
              <p className="text-[13px] text-white/20 mt-2">{t("settingsPage.providerAutoUse")}</p>
            </div>
