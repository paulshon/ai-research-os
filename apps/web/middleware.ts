...
/* v15: Clerk 키 미설정(오프라인 Electron/로컬 모드) 시 clerkMiddleware가 매 요청마다
   throw → 전체 500. 키가 없으면 인증 게이트를 건너뛰는 pass-through로 폴백한다.
   (클라이언트는 providers.tsx가 이미 무-Clerk 로컬 모드를 지원) */
